...
In this vignette, we are taking the example of gene expression profiles from microdissected epithelium 
...
Each object of the list must include the following objects:
...
Again, for the web application data must be saved in the data folder of
the mixt package with the same format and naming approach:
* perm_cor_p is a list of all possible comparison between tissues  
* Members of perm_cor_p should be named as follow  
    + same tissue comparisons: "tissuename2"
    + two-tissue comparison: "tissuename1_tissuename2"
